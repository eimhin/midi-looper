...
static constexpr int PARAMS_PER_TRACK = 22; // Parameters per track
static constexpr int GLOBAL_PARAMS = 22;    // Global parameters (Run Input, Clock Input, Record, Generate, etc.)
